...
if __name__ == "__main__":
    ...
    trigger_words=['小孩','孩子','宝宝','妈妈','月子','奶瓶','幼儿','新生儿','儿童','儿子','女儿','婴儿','胎儿','爸爸','母爱','麻麻','避孕','妊娠','孕期','孕妇','母乳','疫苗','辣妈','妈','当妈','怀孕','宝妈','母婴','孕妈','奶爸','宝贝' , '辅食' ,'奶粉' ,'男孩' ,'女孩','男宝' ,'女宝' ,'女宝' ,'湿疹' ,'父母' ,'母亲' ,'父亲' ,'元素' ,'微量元素', '臭臭' ,'哺乳' ,'米粉' ,'父教' ,'产妇' ,'堕胎' ,'纸尿裤','尿裤','娃','小儿','尿不湿','回奶','断奶','早教','胎教','吐奶','待产','宝','童车','孕前','孕','奶嘴','早产','冲奶','育儿','月嫂','叶酸','二胎','吸乳','乳汁','产前','产后','奶水','亲子装']
    mode_list=['val','test','train']
